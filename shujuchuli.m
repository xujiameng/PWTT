function [pwtt,bp]=shujuchuli(data)
load '实验数据/实验数据3/mat/data2/data2_23';
% data=data((30000:end),:);
time=data(:,1);%%获取时间序列
ppg=data(:,2);%%获取ppg数据
ecg=data(:,3);%%获取ecg数据
...
[max_BP,u_bp,BF]=BP250_2(BP,fs);%%获取BP数据的峰值点位置信息
...
pwtt1((delect))=[];%将干扰点位置置0
pwtt2((delect))=[];%将干扰点位置置0
pwtt3((delect))=[];%将干扰点位置置0
...
% % plot(t,BF);
% % hold on;
% % plot(d,uu(d),'d',max_BP,BF(max_BP),'k+');
% % 
% % figure(3)
% % plot(t,d_ppg);
% % hold on;
...
bp((delect))=[];
pwtt=pwtt3;
% % % save(['实验数据/实验数据3/mat/data2_7step最终/PWTT/pwtt1/pwtt24'],'pwtt') ;
% % % pwtt=pwtt2;
% % % save(['实验数据/实验数据3/mat/data2_7step最终/PWTT/pwtt2/pwtt24'],'pwtt') ;
% % % pwtt=pwtt3;
% % % save(['实验数据/实验数据3/mat/data2_7step最终/PWTT/pwtt3/pwtt24'],'pwtt') ;
% % % save(['实验数据/实验数据3/mat/data2_7step最终/BP/bp24'],'bp') ;
% % hold on 
% % plot(pwtt1,bp1);
